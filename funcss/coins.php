...
//    sendproductbalance( "coins", "coins", "mBTC", $amount, $name,"coinbuy" );
    //echo 
    sendproductbalance( $coinPageHolder, $coinPageCreator, $coinPageProduct, $amount, $name,"coinbuy" );
...
//    $var1 = 0.481234; //getnewprice()
    ...
    include_once( "sendproduct.php" );
    //echo 
    sendproductbalance( $name1, $coinPageCreator, $coinPageEuro, $var5, $coinPageHolder, "cointrade" );
    //echo "<br> "; 
    //echo 
    sendproductbalance( $coinPageHolder, $coinPageCreator, $coinPageProduct, $amount, $name1, "cointrade");
...
//    $var1 = 0.481234; //getnewprice()
    ...
    include_once '../sitename.inc';
    include_once( "../funcss/listtrades.php" );
    $available = showHowMuch2( $coinPageCreator, $coinPageProduct, $name1 );

    if ( $amount > $available )
    {
        return "insufficient funds!! $amount > $available ";
    }
    ...
    include_once( "sendproduct.php" );
//    echo 
    sendproductbalance( $name1, $coinPageCreator, $coinPageProduct, $amount, $coinPageHolder, "cointrade" );
    //echo "<br> ";
//    echo 
    sendproductbalance( $coinPageHolder, $coinPageCreator, $coinPageEuro, $var5, $name1, "cointrade");
...
/*    
    ...
    echo "5 " . $varr[5] . " <br>";
*/
    notify5( $varr[0], $varr[1], $varr[2], $varr[3], $varr[4] ); 
}


function notify5( $var1, $var2, $varamount, $varconfs, $varaddress, $txid )
{
//    echo "notify5( $var1, $var2, $varamount, $varconfs, $varaddress, $txid )<br>";
    $varr[0] = $var1;
    $varr[1] = $var2;
    $varr[2] = $varamount;
    $varr[3] = $varconfs;
...
function getrecentness( $valuevar, $timevar )
{
//    echo "1<br>";
    $q1 = myquery( "select
            thevalue, datetime
...
////        echo $row2[1] . "  " .  $row2[0] . "  ...<br>";
        ...
        $varar = btcsendamount( $amount, $address );
...
function btcnewaddress()
{
    //return address;
    
    include_once( "../funcss/coins2.notrack.php" );
    return getnewaddressck();
}

        
function btcsendamount( $varamount, $varaddress )
{
//    echo "( $varamount, $varaddress )<br>";
    
    
    //$var[0] = "ok";
    //$var[1] = transaction id;
    ...
    $var = '';
    include_once( "../funcss/coins2.notrack.php" );
    $var = sendfundsck( $varamount, $varaddress );
...
function btccheckdeposits( $limit = 25 )
{
    include_once( "../funcss/coins2.notrack.php" );
    checkeventsck();
    //get $limit recent deposits and send them through notify
    //return ??
}
